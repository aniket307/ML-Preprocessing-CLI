    ...
    def normalization(self):
        while (1):
            ...
            if choice == -1:
                ...
                columns = input("Enter all the column" + self.bold_start + "(s)" +
                                self.bold_end + "you want to normalize (Press -1 to go back)  ").lower()
                if columns == "-1":
                    break
                for column in columns.split(" "):
                    try:
                        ...
                        self.data[column] = (
                            self.data[column] - minValue)/(maxValue - minValue)
                    except:
                ...
                try:
                    ...
                    print("\nString Columns are present. So, " + self.bold_start + "NOT" +
                          self.bold_end + " possible.\U0001F636\nYou can try the first option though.")
            ...
            if choice == -1:
                ...
                for column in columns.split(" "):
                    try:
                        ...
                        self.data[column] = (
                            self.data[column] - mean)/(standard_deviation)
                    except:
                        print("\nNot possible....\U0001F636")
                print("Done....\U0001F601")
