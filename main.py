...
from HandleNulls import HandleNulls
...
class Preprocessor:
    ...
    def __init__(self):
        ...
        # print(self.data);
        print("\n\n" + self.bold_start +
              "WELCOME TO THE MACHINE LEARNING PREPROCESSOR CLI!!!\N{grinning face}" + self.bold_end + "\n\n")
...
# remove try cath
    ...
    def preprocessorMain(self):
        ...
        while (1):
            print("\nTasks we can help you with\U0001F447\n")
            ...
            if choice == -1:
                ...
                self.data = HandleNulls(self.data).removenull()
            elif choice == 3:
